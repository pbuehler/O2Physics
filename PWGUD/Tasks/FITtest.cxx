...
struct FITtest {
  ...
  void init(InitContext& context)
  {
    ...
    if (context.mOptions.get<bool>("processMain")) {
      ...
      // collisions
      registry.add("All/Stat",
                   "Cut statistics; Selection criterion; Collisions",
                   {HistType::kTH1F, {{20, -0.5, 20.5}}});
      registry.add("All/AllRelBC",
                   "Total Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("All/RelativeBC",
                   "Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("All/trkmultiplicity",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("All/PVCFIT",
                   "PV contributors with FIT; PV contributors; Tracks",
                   {HistType::kTH1F, {{100, -0.5, 99.5}}});
      registry.add("All/PVTracks",
                   "Number of PV tracks; Number of PV tracks; Collisions",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("All/etapt",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("All/dEdxTPC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("All/dEdxTOF",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});
      registry.add("All/trketa",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("All/trkpt",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});

      // FV0
      registry.add("All/FV0/hV0A", "Time FV0A; Time (ns); Collisions",
                   {HistType::kTH1F, {{500, -50.0, 50.0}}});
      registry.add("All/FV0/FV0Amp", "FV0A Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});
      registry.add("All/FV0/FV0A", "#FV0A; Channel; FV0A Amplitude",
                   {HistType::kTH2F, {{48, -0.5, 47.5}, {2000, 0., 2000.}}});

      // FT0
      registry.add("All/FT0/hT0AC",
                   "Time Correlation FT0; FT0A Time (ns) ; FT0C Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("All/FT0/FT0Aamp", "#FT0A Amplitude; FT0A Amplitude",
                   {HistType::kTH1F, {{2000, -4.5, 1995.5}}});
      registry.add("All/FT0/FT0Camp", "#FT0C Amplitude; FT0C Amplitude",
                   {HistType::kTH1F, {{2000, -4.5, 1995.5}}});
      registry.add("All/FT0/FT0A", "#FT0A; Channel; FT0A Amplitude",
                   {HistType::kTH2F, {{96, -0.5, 95.5}, {1000, 0., 1000.}}});
      ...
      registry.add("All/FDD/hFDDAC",
                   ...
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("All/FDD/FDDAamp", "#FDDA Amplitude; FDDA Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("All/FDD/FDDCamp", "#FDDC Amplitude; FDDC Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("All/FDD/FDDA", "#FDDA; Channel; FDDA Amplitude",
      ...
      registry.add("All/ZDC/hZNAC",
                   "Time Correlation ZN; ZNA Time (ns) ; ZNC Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("All/ZDC/hZPAC",
                   "Time Correlation ZP; ZPA Time (ns) ; ZPC Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("All/ZDC/hZEM12",
                   "Time Correlation ZEM; ZEM1 Time (ns) ; ZEM2 Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});

      registry.add("All/ZDC/ZNAamp", "ZNA Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});
    ...
    if (context.mOptions.get<bool>("processHadronic")) {
      registry.add("collHadronic/Stat",
                   "Cut statistics; Selection criterion; Collisions",
                   {HistType::kTH1F, {{20, -0.5, 20.5}}});
      registry.add("collHadronic/RelBC",
                   "Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("collHadronic/trkmult",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("collHadronic/PVTrk",
                   "Number of PV tracks; Number of PV tracks; Collisions",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("collHadronic/etapt",
                   "Eta vs pT; eta of track; pT of track [MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("collHadronic/dEdxTPC",
                   "TPC signal vs signed track pt; Signed track pt [GeV/c]; "
                   "TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("collHadronic/dEdxTOF",
                   "TOF signal vs signed track pt; Signed track pt [GeV/c]; "
                   "TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});
      registry.add("collHadronic/trketa",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("collHadronic/trkpt",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});

      registry.add("collHadronic/trketaZDC",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("collHadronic/trkptZDC",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});
      registry.add("collHadronic/trkmultZDC",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("collHadronic/PVTrkZDC",
                   "Number of PV tracks; Number of PV tracks; Collisions",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("collHadronic/etaptZDC",
                   "Eta vs pT; eta of track; pT of track [MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("collHadronic/dEdxTPCZDC",
                   "TPC signal vs signed track pt; Signed track pt [GeV/c]; "
                   "TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("collHadronic/dEdxTOFZDC",
                   "TOF signal vs signed track pt; Signed track pt [GeV/c]; "
                   "TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});

      // FV0
      registry.add("collHadronic/FV0/hV0A", "Time FV0A; Time (ns); Collisions",
                   {HistType::kTH1F, {{500, -50.0, 50.0}}});
      registry.add("collHadronic/FV0/FV0Amp", "FV0A Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});

      // FT0
      registry.add("collHadronic/FT0/hT0AC",
                   "Time Correlation FT0; FT0A Time (ns) ; FT0C Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("collHadronic/FT0/FT0Aamp",
                   "#FT0A Amplitude; FT0A Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("collHadronic/FT0/FT0Camp",
      ...
      registry.add("collHadronic/FDD/hFDDAC",
                   "Time Correlation FDD; FDDA time (ns); FDDC time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("collHadronic/FDD/FDDAamp",
                   "#FDDA Amplitude; FDDA Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("collHadronic/FDD/FDDCamp",
    ...
    if (context.mOptions.get<bool>("processInclusiveA")) {
      ...
      registry.add("colInclusiveA/Stat",
                   "Cut statistics; Selection criterion; Collisions",
                   {HistType::kTH1F, {{20, -0.5, 20.5}}});
      registry.add("colInclusiveA/RelativeBC",
                   "Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("colInclusiveA/trkmultiplicity",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveA/PVTracks",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveA/etapt",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("colInclusiveA/dEdxTPC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("colInclusiveA/dEdxTOF",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});

      registry.add("colInclusiveA/trketa",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("colInclusiveA/trkpt",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});
      registry.add("colInclusiveA/trketaZDC",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("colInclusiveA/trkptZDC",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});
      registry.add("colInclusiveA/trkmultZDC",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveA/PVTracksZDC",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveA/etaptZDC",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("colInclusiveA/dEdxTPCZDC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("colInclusiveA/dEdxTOFZDC",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});

      // FV0
      registry.add("colInclusiveA/FV0/FV0Amp", "FV0A Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});
      // FT0
      registry.add("colInclusiveA/FT0/hT0AC",
                   "Time Correlation FT0; FT0A Time (ns) ; FT0C Time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add("colInclusiveA/FT0/FT0Aamp",
                   "#FT0A Amplitude; FT0A Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("colInclusiveA/FT0/FT0Camp",
                   "#FT0C Amplitude; FT0C Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add(
      ...
      registry.add("colInclusiveA/FDD/FDDAamp",
                   "#FDDA Amplitude; FDDA Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("colInclusiveA/FDD/FDDCamp",
                   "#FDDC Amplitude; FDDC Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("colInclusiveA/FDD/hFDDAC",
                   "Time Correlation FDD; FDDA time (ns); FDDC time (ns)",
                   {HistType::kTH2F, {{500, -50.0, 50.0}, {500, -50.0, 50.0}}});
      registry.add(
    ...
    if (context.mOptions.get<bool>("processInclusiveC")) {
      registry.add("colInclusiveC/Stat",
                   "Cut statistics; Selection criterion; Collisions",
                   {HistType::kTH1F, {{20, -0.5, 20.5}}});
      registry.add("colInclusiveC/RelativeBC",
                   "Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("colInclusiveC/trkmultiplicity",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveC/PVTracks",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveC/etapt",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("colInclusiveC/dEdxTPC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("colInclusiveC/dEdxTOF",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});
      registry.add("colInclusiveC/trketa",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("colInclusiveC/trkpt",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});

      registry.add("colInclusiveC/trketaZDC",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("colInclusiveC/trkptZDC",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});
      registry.add("colInclusiveC/trkmultZDC",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveC/PVTracksZDC",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("colInclusiveC/etaptZDC",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("colInclusiveC/dEdxTPCZDC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("colInclusiveC/dEdxTOFZDC",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});

      // FV0
      registry.add("colInclusiveC/FV0/FV0Amp", "FV0A Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});
      // FT0
      registry.add("colInclusiveC/FT0/FT0Aamp",
                   "#FT0A Amplitude; FT0A Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("colInclusiveC/FT0/FT0Camp",
                   "#FT0C Amplitude; FT0C Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add(
      ...
      registry.add("colInclusiveC/FDD/FDDAamp",
                   "#FDDA Amplitude; FDDA Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add("colInclusiveC/FDD/FDDCamp",
                   "#FDDC Amplitude; FDDC Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
      registry.add(
    ...
    if (context.mOptions.get<bool>("processExclusive")) {
      registry.add("exclusive/Stat",
                   "Cut statistics; Selection criterion; Collisions",
                   {HistType::kTH1F, {{20, -0.5, 20.5}}});
      registry.add("exclusive/RelativeBC",
                   "Relative BC number; Relative BC; Collisions",
                   {HistType::kTH1F, {{3564, -0.5, 3563.5}}});
      registry.add("exclusive/trkmultiplicity",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("exclusive/PVTracks",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("exclusive/etapt",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("exclusive/dEdxTPC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("exclusive/dEdxTOF",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});
      registry.add("exclusive/trketa",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("exclusive/trkpt",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});

      registry.add("exclusive/trketaZDC",
                   "Eta distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{80, -2., 2.}}});
      registry.add("exclusive/trkptZDC",
                   "Pt distribution of tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{100, 0., 5.}}});
      registry.add("exclusive/trkmultZDC",
                   "Multiplicity of all tracks; Multiplicity; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("exclusive/PVTracksZDC",
                   "Number of PV tracks; Number of PV tracks; Tracks",
                   {HistType::kTH1F, {{300, -0.5, 299.5}}});
      registry.add("exclusive/etaptZDC",
                   "eta versus pT of all tracks; eta of track; p_T of track "
                   "[MeV/c^2]; Tracks",
                   {HistType::kTH2F, {{80, -2., 2.}, {100, 0., 5.}}});
      registry.add("exclusive/dEdxTPCZDC",
                   "TPC signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TPC signal; Tracks",
                   {HistType::kTH2F, {{120, -6., 6.}, {1000, 0., 1000.}}});
      registry.add("exclusive/dEdxTOFZDC",
                   "TOF signal versus signed track momentum; Signed track "
                   "momentum [GeV/c]; TOF signal; Tracks",
                   {HistType::kTH2F, {{1000, 0., 10.}, {1000, 0., 10.}}});

      // FV0
      registry.add("exclusive/FV0/FV0Amp", "FV0A Amplitude",
                   {HistType::kTH1F, {{2000, 0., 2000.}}});

      // FT0
      registry.add("exclusive/FT0/FT0Aamp", "#FT0A Amplitude; FT0A Amplitude",
                   {HistType::kTH1F, {{2000, -0.5, 1999.5}}});
                   ...
                   aod::V0s const& v0s)
  {
    ...
    if (collision.has_foundFT0() || collision.has_foundFDD() ||
        collision.has_foundFV0() || collision.has_foundZDC()) {
                       ...
                       aod::V0s const& v0s)
  {
    ...
    // FV0 information
    if (collbc.has_foundFV0()) {
      registry.get<TH1>(HIST("collHadronic/Stat"))->Fill(4.);

      auto fv0 = collbc.foundFV0();
    ...
    /*auto FITA = totalAmplitudefv0 > 0. || totAmplitudeA > 0. || totAmpFddA >
    0.; auto FITC = totAmplitudeC > 0. || totAmpFddC > 0.; auto ZDCA =
    (totAmpZNA >0. ||  totAmpZPA > 0.|| totAmpZEM1>0. || totAmpZEM2 > 0.); auto
    ZDCC = (totAmpZNC >0. ||  totAmpZPC > 0.);*/

    // if (!ZDCA || !ZDCC) return; // investigate events with ZDC signal on both
    // sides
    if (isDGcandidate) {
      ...
      // if (!FITA || !FITC) return; // investigate events with FIT signal on
      // both sides
      // if (!ZDCA || !ZDCC) return;
      ...
      /*  for (auto const& trk : tracks) {
            if (trk.eta() > -1.5 && trk.eta() < 1.5) {
                if(trk.pt() < 10){
                    ...
                    registry.get<TH2>(HIST("collHadronic/etaptZDC"))->Fill(trk.eta(),
        trk.pt(), 1.);
                    registry.get<TH2>(HIST("collHadronic/dEdxTPCZDC"))->Fill(trk.tpcInnerParam()
        / trk.sign(), trk.tpcSignal()); if (trk.hasTOF())
        {registry.get<TH2>(HIST("collHadronic/dEdxTOFZDC"))->Fill(trk.p() /
        trk.sign(), trk.beta());}
                }
            }
        }//tracks
                         ...
                         aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    auto ZDCA = (totAmpZNA > 2. || totAmpZPA > 2. || totAmpZEM1 > 2. ||
                 totAmpZEM2 > 2.);
    auto ZDCC = (totAmpZNC > 2. || totAmpZPC > 2.);
                         ...
                         aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    auto FITA = totalAmplitudefv0 > 2. || totAmplitudeA > 2. || totAmpFddA > 2.;
    auto FITC = totAmplitudeC > 2. || totAmpFddC > 2.;
    auto ZDCA = (totAmpZNA > 2. || totAmpZPA > 2. || totAmpZEM1 > 2. ||
                 totAmpZEM2 > 2.);
    auto ZDCC = (totAmpZNC > 2. || totAmpZPC > 2.);
                        ...
                        aod::Zdcs& zdcs, aod::V0s const& v0s)
  {
    ...
    // auto FITA = totalAmplitudefv0 > 0. || totAmplitudeA > 0. || totAmpFddA >
    // 0.; auto FITC = totAmplitudeC > 0. || totAmpFddC > 0.; auto ZDCA =
    // (totAmpZNA >50. ||  totAmpZPA > 50.|| totAmpZEM1>50. || totAmpZEM2
    // > 50.); auto ZDCC = (totAmpZNC >50. ||  totAmpZPC > 50.);

    if (totAmplitudeA < 20. || totAmplitudeC < 20. || totalAmplitudefv0 < 10. ||
        totAmpFddA < 10 || totAmpFddA < 10) {
  ...
  PROCESS_SWITCH(FITtest, processExclusive,
